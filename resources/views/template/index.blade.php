				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item {{ Request::segment(1) === 'ticket' ? 'active submenu' : null }}">
							...
							<div class="collapse {{ Request::segment(1) === 'ticket' ? 'show' : null }}" id="tables">
								<ul class="nav nav-collapse">
									<li class="{{ Request::segment(1) === 'ticket' && empty(Request::segment(2)) ? 'active' : null }}">
										<a href="{{ route('usr.ticket') }}">
											<span class="sub-item text-warning">Belum Diatasi</span>
										</a>
									</li>
									<li class="{{ Request::segment(1) === 'ticket' && Request::segment(2) === 'nonaktif' ? 'active' : null }}">
										<a href="{{ route('usr.ticketnonaktif') }}">
											<span class="sub-item text-success">Sudah Diatasi</span>
										</a>
									</li>
                                    <li class="{{ Request::segment(1) === 'ticket' && Request::segment(2) === 'all' ? 'active' : null }}">
